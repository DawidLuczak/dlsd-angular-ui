...
export class DropdownDirective<T> implements OnInit {
  ...
  public dropdownHeaderTemplateRef = input<TemplateRef<unknown>>();
  public dropdownFooterTemplateRef = input<TemplateRef<unknown>>();
  public dropdownAddOption = input<boolean>();
  ...
  public dropdownFooterOption = input<DropdownOption<T>>();
  ...
  private attachDropdown(): void {
    ...
    this.dropdownService.attachDropdown(
      ...
      DROPDOWN_CONFIG<T>(),
      {
        addOption: this.dropdownAddOption(),
        ...
        focusSourceElement: () => this.elementRef.nativeElement.focus(),
        footerOption: this.dropdownFooterOption(),
        footerTemplateRef: this.dropdownFooterTemplateRef(),
        handleAddOption: () => {
          this.dropdownOptionAdd.emit();
          setTimeout(() => this.detachDropdown());
        },
        hasBackdrop: this.dropdownHasBackdrop(),
        headerTemplateRef: this.dropdownHeaderTemplateRef(),
